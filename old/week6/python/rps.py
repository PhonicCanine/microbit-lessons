...
def play():
    ...
    '''We need to make the game run forever (hint: think back to loops)'''
    if True:
        if button_a.is_pressed() and button_b.is_pressed():
            ...
            '''Change the player's choice, and make sure that it's <= 2 (hint: using modulus (%) is a good idea here, and you'll need to replace choice = 0)'''
            choice = 0
            displayPlayerChoice(choice,1)
